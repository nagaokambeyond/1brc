...
public class AirTemperature4 {
    private int minimumTemperature;
    private int maximumTemperature;
    private int summaryTemperature;
    private int count;

    public AirTemperature4(int temperature) {
    ...
    public AirTemperature4 add(int temperature) {
    ...
    public AirTemperature4 add(AirTemperature4 temperature) {
